        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="text" name="price_from" value="<?= $info->price_from ?>" class="form-control" placeholder="0" data-format_price>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              <label>Đến (tỷ) <span class="label label-danger">(Bắt buộc) <?= form_error('price_to') ?></span></label>
              <input type="text" name="price_to" value="<?= $info->price_to ?>" class="form-control" placeholder="0" data-format_price>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
