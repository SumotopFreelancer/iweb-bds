            ...
            <div class="col-md-8">
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        <a target="_blank" class="pull-right cus_view_flast" href="<?= site_url(_tags . '/' . $info->url) ?>"><i class="fa fa-eye"></i> Xem</a>
                    </div>
                    <?php $this->load->view('admin/message', $this->data); ?>
                    <div class="box-body">
                        <div class="form-group">
                            <label>Tên <span class="label label-danger">(Bắt buộc) <?= form_error('name') ?></span></label>
                            <input type="text" name="name" value="<?= htmlentities($info->name) ?>" class="form-control" id="auto_convert_tags">
