...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?= admin_url('pages') ?>">Trang</a></li>
        <li class="active">Chỉnh sửa</li>
    </ol>
</section>
<section class="content">
    <form action="" method="POST" id="form" data-model="pages_model" data-action="edit" data-id="<?= $info->id ?>">
        <div class="row">
            <div class="col-md-8">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Nội dung</h3>
                        <a target="_blank" class="pull-right cus_view_flast" href="<?= site_url(_pg . '/' . $info->url) ?>"><i class="fa fa-eye"></i> Xem</a>
                    </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group hidden">
                            ...
                            <select class="form-control" name="type">
                                <option value="default" <?= ($info->type == 'default') ? 'selected' : '' ?>>Mặc định</option>
                                <option value="vanban" <?= ($info->type == 'vanban') ? 'selected' : '' ?>>Văn bản</option>
                            </select>
                        </div>
                        <div class="form-group hidden">
                            <label>Thứ tự</label>
