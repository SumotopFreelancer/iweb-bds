...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?= admin_url('catalogimage') ?>">Danh mục</a></li>
        <li class="active">Chỉnh sửa</li>
    </ol>
</section>
<section class="content">
    <form action="" method="POST" id="form" data-model="catalogimage_model" data-action="edit" data-id="<?= $info->id ?>">
        <div class="row">
            <div class="col-md-8">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Nội dung</h3>
                        <a target="_blank" class="pull-right cus_view_flast" href="<?= base_url(_cim . '/' . $info->url) ?>"><i class="fa fa-eye"></i> Xem</a>
                    </div>
