...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?= admin_url('services') ?>">Dịch vụ</a></li>
        <li class="active">Chỉnh sửa</li>
    </ol>
</section>
<section class="content">
    <form action="" method="POST" id="form" data-model="services_model" data-action="edit" data-id="<?= $info->id ?>">
        <div class="row">
            <div class="col-md-8">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Nội dung</h3>
                        <a target="_blank" class="pull-right cus_view_flast" href="<?= site_url(_dv . '/' . $info->url) ?>"><i class="fa fa-eye"></i> Xem</a>
                    </div>
            ...
            <div class="col-md-4">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group hidden">
                            ...
                            <div id="wGallery" class="cus_image_action">
                                <?php if (isJson($info->image_list)) : ?>
                                    <?php foreach (isJson($info->image_list) as $img => $alt) : ?>
                                        <div class="col-md-6">
                                            <input name="gallery[]" type="hidden" value="<?= $img ?>">
                                            <div class="cus_img_box"><img src="<?= $img ?>" class="img-responsive"></div>
                                            <input name="altGallery[]" type="text" value="<?= $alt ?>" placeholder="Alt ảnh">
                        ...
                        <div class="form-group <?= switch_sort($setadmin->sort_services) ?>">
                            <label>Thứ tự</label>
