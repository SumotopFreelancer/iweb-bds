...
<section class="content">
    <form action="" method="POST" id="form" data-model="services_model" data-action="add">
        <div class="row">
            <div class="col-md-8">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="intro" class="form-control editor" rows="10" cols="80"><?= set_value('intro') ?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="list_catalog">
                                <?php if (isset($catalog) && $catalog) : ?>
                                    ...
                                    <?php endforeach; ?>
                                <?php else : ?>
                                    <a class="setupcatalog" href="<?= admin_url('catalogservice/add') ?>"><i class="fa fa-exclamation-triangle"></i> CLICK THÊM DANH MỤC</a>
                                <?php endif; ?>
                            </div>
