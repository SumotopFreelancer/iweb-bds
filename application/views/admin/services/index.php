...
<section class="content-header">
  <h1>Dịch vụ
    <a href="<?= admin_url('services/add') ?>" class="btn btn-success btn-flat">
  ...
  <div class="box">
    ...
    <div class="box-body table-responsive no-padding mailbox-messages">
      <table class="table table-hover">
        <form method="GET" action="<?= admin_url('services') ?>">
          <tr>
            <th style="width: 30%">
            ...
            <th class="pull-right">
              ...
              <a href="<?= admin_url('services') ?>" title="Làm mới" class="btn btn-default" type="submit"><i class="fa fa-refresh"></i></a>
            </th>
          </tr>
        </form>
      </table>
          ...
          <tr class='row_<?= $row->id ?>'>
            ...
            <td>
              <div class="info-default">
                ...
                <div class="name"><a class="text-black line-1" target="_blank" href="<?= site_url(_dv . '/' . $row->url) ?>"><?= $row->name ?></a></div>
              </div>
            </td>
            <td><b class="line-1"><?= $this->catalogservice_model->get_info($row->catalog_id)->name ?></b></td>
            ...
            <td class="b-active">
              <a href="<?= admin_url('services/edit/' . $row->id) ?>" class="btn btn-sm btn-social-icon btn-warning" title="Chỉnh sửa"><i class="fa fa-edit fa-fw"></i></a>
              <a href="<?= admin_url('services/delete/' . $row->id) ?>" class="btn btn-sm btn-social-icon btn-danger btn_del_one" title="Xóa"><i class="fa fa-trash-o fa-fw"></i></a>
            </td>
          </tr>
        <?php endforeach; ?>
      </table>
    ...
    <div class="box-footer clearfix">
      <button type="button" class="btn btn-sm btn-danger btn_del_all" url="<?= admin_url('services/del_all') ?>">Xóa hết</button>
      <?= $phantrang ?>
    </div>
  </div>
</section>
