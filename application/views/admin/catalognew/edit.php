...
<section class="content">
    <form action="" method="POST" id="form" data-model="catalognew_model" data-action="edit" data-id="<?= $info->id ?>">
        <div class="row">
            <div class="col-md-8">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Nội dung</h3>
                        <a target="_blank" class="pull-right cus_view_flast" href="<?= base_url(_cblog . '/' . $info->url) ?>"><i class="fa fa-eye"></i> Xem</a>
                    </div>
            ...
            <div class="col-md-4">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group <?= switch_sort($setadmin->sort_catalog_new) ?>">
                            <label>Thứ tự</label>
