                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="chucdanh" value="<?= $info->chucdanh ?>" class="form-control" placeholder="Chức danh">
                        </div>
                        <div class="form-group">
                            <label>Ý kiến</label>
                            <textarea name="ykien" class="form-control" rows="5" placeholder="Nhập ý kiến"><?= $info->ykien ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
